//
//  main.cpp
//  Calculadora binario macOS
//
//  Created by Thales Fernandes on 03/04/22.
//
	...
	do
	{
		...
		cin  >> opcao;
				...
				if (opcao == 1)
					{
						cout << " "<< endl;
						cout << "Você escolheu Decimal papa Binário. Digite um número em Decimal (até 2047): " <<endl;
						cin  >> decimal;
						cout <<" " << endl;
						...
						if (opcao == 2)
							{
								...
								int i = 0;
								for (int i = 0; i < 11; i++)
									{ //aqui delimita o tamanho do número a ser transformado
